...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Aucun ministage pour votre établissement" )
		{
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'première', 'précédent', 'suivant', 'dernière' ];
		},
	
		simple_numbers: function ( page, pages ) {
			return [ 'précédent', _numbers(page, pages), 'dernière' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'première, 'précédent', _numbers(page, pages), 'next', 'last' ];
		},
